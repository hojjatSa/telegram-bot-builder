  ...
  return (
    <div className="w-[380px] shrink-0 h-full bg-card border-l border-border flex flex-col overflow-hidden">
      <div className="flex items-center gap-2 px-3 py-2 border-b border-border shrink-0">
        ...
        <span className="text-sm font-medium flex-1">String not found</span>
      ...
      <div className="px-4 py-4 text-sm text-muted-foreground space-y-2">
        <p>
          Log <code className="text-xs bg-muted px-1 py-0.5 rounded font-mono">{logId}</code> unavailable.
        </p>
        <p className="text-xs leading-relaxed">
          The entry may have been deleted when the terminal was cleared or the storage limit expired.
        </p>
      </div>
    </div>
  );
